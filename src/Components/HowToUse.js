...
const HowToUse = () => {
  return (
    <div className='text-center flex flex-col bg-yellow p-4 rounded-lg w-52 px-8 shadow-lg'>
        ...
        <button className="my-3 bg-opacity-0 border-2 border-green rounded-md px-3 py-1 text-green font-bold hover:bg-green hover:text-yellow/80">To the guide</button>
    </div>
  )
}
