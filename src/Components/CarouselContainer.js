    ...
    <Carousel showThumbs={false}>
      <div className="flex gap-12 pr-10 pb-20">
        <div className="w-1/2 my-auto">
            ...
            <button className="border-2 border-green rounded-md px-3 py-1 text-green font-bold hover:bg-green hover:text-[#f1f5ee]">Visit this home</button>
        </div>
        <div className="w-1/3 mx-auto overflow-hidden">
            <img src="https://i.ibb.co/CJQ9LVQ/Choose-Location.png" alt="TestImage"/>
        </div>
      </div>
      ...
      <div className="flex gap-12 pr-10 pb-20">
        ...
        <div className="w-1/3 mx-auto overflow-hidden">
            <img src="https://i.ibb.co/tZFqcS2/Trust-Hands.png" alt="TestImage2" />
        </div>
      </div>
      ...
      <div className="flex gap-12 pr-10 pb-20">
        ...
        <div className="w-1/3 mx-auto overflow-hidden">
            <img src="https://i.ibb.co/sjPZ2CD/Holding-Globe.png" alt="TestImage" />
        </div>
      </div>
    </Carousel>
  );
