    ...
    <Carousel showThumbs={false}>
      <div className="flex gap-12 pr-10 pb-10">
        <div className="flex flex-col w-1/2 my-auto text-start">
          <div className="flex w-3/5 ml-32 justify-between">
            <h2 className="pb-10 font-heading text-3xl">Getting started.</h2>
            <p className="font-heading -mr-10 text-2xl">1/5</p>
          </div>
          <p className="w-2/3 ml-32 pb-10">
      ...
      <div className="flex gap-12 pr-10 pb-10">
        <div className="flex flex-col w-1/2 my-auto text-start">
          <div className="flex w-3/5 ml-32 justify-between">
            ...
            <p className="font-heading -mr-10 text-2xl">2/5</p>
          </div>
          <p className="w-2/3 ml-32 pb-10">
      ...
      <div className="flex gap-12 pr-10 pb-10">
        <div className="flex flex-col w-1/2 my-auto text-start">
          <div className="flex w-3/5 ml-32 justify-between">
            ...
            <p className="font-heading -mr-10 text-2xl">3/5</p>
          </div>
          <p className="w-2/3 ml-32 pb-10">
      ...
      <div className="flex gap-12 pr-10 pb-10">
        <div className="flex flex-col w-1/2 my-auto text-start">
          <div className="flex w-3/5 ml-32 justify-between">
            ...
            <p className="font-heading -mr-10 text-2xl">4/5</p>
          </div>
          <p className="w-2/3 ml-32 pb-10">
      ...
      <div className="flex gap-12 pr-10 pb-10">
        <div className="flex flex-col w-1/2 my-auto text-start">
          <div className="flex w-3/5 ml-32 justify-between">
            ...
            <p className="font-heading -mr-10 text-2xl">5/5</p>
          </div>
          <p className="w-2/3 ml-32 pb-10">
